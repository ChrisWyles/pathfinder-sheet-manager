...
const ITEMS: {
  ...
  // Dagger/Longsword/Greatsword/Shortbow/Quarterstaff and Chain Shirt/
  // Breastplate/Full Plate used to be hand-seeded here, but they're now
  // covered (with more accurate stats) by the full d20pfsrd weapon/armor
  // scrape — see scripts/scrape-weapons.ts and scripts/scrape-armor.ts.
  // Keeping both created duplicate catalog entries.
  {
    name: "Padded Armor",
    type: "ARMOR",
    costCp: 500,
